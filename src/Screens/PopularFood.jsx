...
const PopularFood = () => {
    const [PopularFoodAPI, setPopularFoodData] = useState([]);
    ...
    useEffect(() => {
        fetch('https://raw.githubusercontent.com/FoodieMunch/Foodie-Munch/main/FoodAPI.json')
            ...
            .then((data) => {
                if (data && data.PopularFoodAPI) {
                    setPopularFoodData(data.PopularFoodAPI);
                }
            })
            .catch((error) => {
                console.error(error);
